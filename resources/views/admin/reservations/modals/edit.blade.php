<div id="edit-modal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg p-6 text-black w-1/2 shadow-lg">
        ...
        <form id="edit-modal-form" method="POST">
            ...
            @method('PUT')
            <div class="mb-4">
                <label for="edit-date_in" class="block text-sm font-medium">Date d'entrée</label>
            ...
            <div class="mb-4">
                <label for="edit-date_out" class="block text-sm font-medium">Date de sortie</label>
            ...
            <div class="mb-4">
                <label for="edit-car_id" class="block text-sm font-medium">Voiture</label>
