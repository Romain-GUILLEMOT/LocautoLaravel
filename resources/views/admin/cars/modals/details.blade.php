    ...
    <div class="bg-white rounded-lg p-6 text-black w-1/2 shadow-lg">
        ...
        <form id="modal-form" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <input type="number" id="price" name="price" class="mt-1 p-2 w-full rounded border border-gray-300 bg-white bg-opacity-50 text-black pr-10">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="date" name="date" class="mt-1 p-2 w-full rounded border border-gray-300 bg-white bg-opacity-50 text-black">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select id="state" name="state" class="mt-1 p-2 w-full rounded border border-gray-300 bg-white bg-opacity-50 text-black">
            ...
            <div class="mb-4">
                <label for="available" class="block text-sm font-medium">Disponible</label>
                <input type="checkbox" id="available" name="available" class="mt-1 p-2 rounded border border-gray-300 bg-white bg-opacity-50 text-black">
            </div>
